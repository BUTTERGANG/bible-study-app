...
function BookmarkRow({ bm, onGo, onDelete }) {
  ...
  return (
    <div className="group flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
      <button
        onClick={onGo}
      ...
      {confirmDelete ? (
        <button
          ...
          className="text-[10px] font-medium text-red-500 hover:text-red-600 px-2 py-1"
        >
          Confirm?
        </button>
      ) : (
